...
str_count2 = str1.count('o', 0,9)
print("The count of 'o' usingstart/end is", str_count2)
print("------END------")

#Count occurrence of a character in a given string
str1 = "Welcome to Python "
str_count1 = str1.count('W')  # counting the character “u” in the given string
print("The count of 'w' is", str_count1)
str_count2 = str1.count('e', 6,15)
print("The count of 'e' usingstart/end is", str_count2)
print("------END------")
